...
from the smallest pieces of data to the comprehensive built-in methods to process them, objects allow the layered organisation of all these things by wrapping them 


#### From window to class
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NDU4ODE4MDMsLTUyMTYyMTU1NiwtNT
