...
This freedom of compositing abstract objects is dizzying at first, as the same data and methods can be referenced by multiple objects. 



#### From window to class
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2ODUyNzE5ODIsLTUyMTYyMTU1NiwtNT
