...
Whereas 'objects' never really clicked in my previous excursions into the language, now it became what was meant by 'everything's and object': 


#### From window to class
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQxNjc3NjAwMiwtNTIxNjIxNTU2LC01NT
